...
class Trip(models.Model):
  ...
  tripFee = models.FloatField()
  driversEarning = models.FloatField()
  startedFrom = models.CharField(max_length=255)
  startedFromLat = models.CharField(max_length=50)
  startedFromLong = models.CharField(max_length=50)
  ...
  destinationLat = models.CharField(max_length=50)
  destinationLong = models.CharField(max_length=50)
  lastChecked = models.DateTimeField(blank=True, null=True)
  tripStatus = models.CharField(max_length=50, choices=TRIP_STATUS_CHOICES, default='way_to_pick_up')
